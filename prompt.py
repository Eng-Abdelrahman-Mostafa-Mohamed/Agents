...
#     {df_str}
#     the generated code full with imports in python is {generated_code_from_agents} and please 
...
#             code that give the answer of query from data (full code with imports) the generated code is {generated_code_from_agents}. """
